// Default Site Configuration & Data for Velora Web Solutions (100% English)
  ...
  services: [
    {
      ...
      features: [
        ...
        "SEO-Optimized & Blazing Fast Speed"
      ],
    ...
    },
    {
      ...
      features: [
        ...
        "UPI, Card & Razorpay Payment Integration"
      ],
    ...
    },
    {
      ...
      features: [
        "High Conversion Rate Architecture",
        "Direct Lead Capture & WhatsApp CTA",
    ...
    },
    {
      ...
      features: [
        "Modern 2026 UI/UX Redesign",
        "Page Speed & Performance Optimization",
        "Bug Fixes & Clean Code Refactoring"
      ],
    ...
    },
    {
      ...
      features: [
        ...
        "Database Architecture & Custom APIs",
        "Tailored Business Logic & Automation"
      ],
    ...
    benefits: [
      {
        ...
        desc: "Chat directly with your developer for instant updates, revisions, and feedback."
      },
      {
        icon: "fa-gauge-high",
        color: "teal",
        title: "Modern Tech & Blazing Speed",
        desc: "Clean code, high Google PageSpeed scores, and responsive mobile architecture."
      },
      {
        icon: "fa-shield-halved",
        color: "indigo",
        title: "100% Satisfaction Guarantee",
        desc: "Unlimited fine-tuning until launch, backed by complimentary post-launch support."
      }
    ],
    steps: [
      {
        ...
        desc: "Share your website goals, reference links, and key requirements."
      },
      {
        num: 2,
        title: "Design & Scope Alignment",
        desc: "We finalize the layout structure, color palette, and essential features."
      },
      {
        num: 3,
        title: "Development & Live Preview",
        desc: "I build the website and provide a private preview link for your review."
      },
      {
        num: 4,
        title: "Final Launch & Support",
        desc: "Your website goes live on your domain with 30 days of free technical support."
      }
    ]
  },
  faqs: [
    {
      ...
      answer: "Starter and single-page portfolio websites are typically delivered within 2-3 business days. Full corporate business websites take 3-5 days, while complete E-Commerce online stores take approximately 5-8 days."
    },
    {
      id: "faq-2",
      question: "How do domain names and web hosting work?",
      answer: "If you already own a domain and hosting, I can deploy directly to your setup. If not, I will guide you through choosing the most reliable and affordable hosting provider and handle the complete configuration."
    },
    {
      id: "faq-3",
      question: "Will my website look great on mobile phones and tablets?",
      answer: "Yes, 100%! Every website is crafted with a mobile-first responsive design, ensuring seamless performance across smartphones, tablets, laptops, and wide monitors."
    },
    {
      id: "faq-4",
      question: "What if I need updates or assistance after the website is launched?",
      answer: "Every project includes 30 days of free technical support for minor text edits, image swaps, and technical maintenance."
    }
  ],
  footer: {
